...
#define RecoJets_JetProducers_HEPTopJetProducer_h
...
namespace cms
{
	class HEPTopJetProducer : public FastjetJetProducer
	{
		public:
		...
		private:
			...
			fastjet::HEPTopTagger				alg_;         		/// The algorithm to do the work
